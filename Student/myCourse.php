 ...
 <div class="container mt-5 ml-4">
  <div class="row">
   ...
   if(isset($stuLoginemail)){
    ...
    c.course_img, c.course_author, c.course_original_price, c.course_price FROM courseorder AS 
    co JOIN course AS c ON c.course_id = co.course_id WHERE co.stu_email = '$stuLoginemail'";
          ...
          <div class="row">
              ...
              <div class="col-sm-6 mb-3">
                <div class="card-body">
                  ...
                  echo $row['course_original_price'] ?> </del></small> <span class="font-weight-bolder">&#8377 
