...
<?php
  ...
  require_once("./PaytmKit/lib/encdec_paytm.php");
	...
	if (isset($_POST["ORDER_ID"]) && $_POST["ORDER_ID"] != "") {
		...
		// In Test Page, we are taking parameters from POST request.
    // In actual implementation these can be collected from session or DB. 
   ...
   <div class="container">
    ...
    <form method="post" action="">
        <div class="form-group d-flex justify-content-center align-items-center"> <!-- Flexbox for alignment -->
            <label class="mr-2">Order ID:</label> <!-- Adjusted spacing -->
            <input class="form-control mx-2" id="ORDER_ID" tabindex="1" maxlength="20" size="20" 
            name="ORDER_ID" autocomplete="off" value="<?php echo $ORDER_ID; ?>" style="width: 200px;">
